...
import {
    ...
    KeyboardAvoidingView, Platform, Image, StatusBar, DeviceEventEmitter
} from 'react-native';
            ...
            <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} keyboardVerticalOffset={Platform.OS === 'ios' ? 90 : 0}>
                <View style={styles.inputContainer}>
                    ...
                    <TouchableOpacity 
                        ...
                        activeOpacity={0.8}
                    >
                        <FontAwesomeIcon icon={faPaperPlane} size={20} color={colors.textBtn} style={{ transform: [{ rotate: '45deg' }] }} />
                    </TouchableOpacity>
                </View>
